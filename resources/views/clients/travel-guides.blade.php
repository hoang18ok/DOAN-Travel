        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-lg-6">
                <div class="benefit-image-part style-two">
                    <div class="image-one" data-aos="fade-down" data-aos-delay="50" data-aos-duration="1500"
                        data-aos-offset="50">
                        <img src="{{ asset('clients/assets/images/benefit/1benefit1.jpg') }}" alt="Benefit">
                    </div>
                    <div class="image-two" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500"
                        data-aos-offset="50">
                        <img src="{{ asset('clients/assets/images/benefit/1benefit2.jpg') }}" alt="Benefit">
                    </div>
                </div>
            </div>
            <div class="col-xl-5 col-lg-6">
                <div class="mobile-app-content rmb-55" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    ...
                    <div class="skillbar mt-80" data-percent="99,99">
                        <span class="skillbar-title">Độ Tin Cậy Của Chúng Tôi </span>
                    ...
                    <a href="about.html" class="theme-btn style-two">
                        <span data-hover="Khám phá Guides">Khám phá </span>
...
<section class="about-team-area pt-100 rel z-1">
    <div class="container">
        ...
        <div class="row justify-content-center">
                ...
                <div class="team-item hover-content" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    ...
                    <div class="content">
                        ...
                        <div class="social-style-one inner-content">
                            ...
                            <a href="https://www.facebook.com/hoang.nguyen.van.90894v"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item hover-content" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <img src="{{ asset('clients/assets/images/team/1guide1.jpg') }}" alt="Guide">
                    <div class="content">
                        <h6>MINH TOAN</h6>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item hover-content" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500"
                    data-aos-offset="50">
                    <img src="{{ asset('clients/assets/images/team/1guide2.jpg') }}" alt="Guide">
                    <div class="content">
                        <h6>TRONG HAI</h6>
