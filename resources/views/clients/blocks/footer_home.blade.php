                ...
                <div class="col-xl-5 col-lg-6" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <div class="footer-widget footer-text">
                        <div class="footer-logo mb-25">
                            <a href="index.html"><img src="{{ asset('clients/assets/images/logos/1logo.png') }}"
                                    alt="Logo"></a>
                        </div>
                ...
                <div class="col col-md-6 col-10 col-small" data-aos="fade-up" data-aos-delay="200"
                    ...
                    <div class="footer-widget footer-contact">
                        ...
                        <ul class="list-style-one">
                            <li><i class="fal fa-map-marked-alt"></i> Kim liên, Nam Đàn, Nghệ An </li>
                            <li><i class="fal fa-envelope"></i> <a
                                    href="mailto:hoang18012003@gmail.com">hoang18012003@gmail.com</a></li>
                            <li><i class="fal fa-clock"></i> Thứ 2 - Thứ 7</li>
                            <li><i class="fal fa-phone-volume"></i> <a href="callto:+88012334588">+84 397367837 </a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="copyright-text text-center text-lg-start">
                        {{-- <p>@Copy 2024 <a href="{{ route('home') }}">Travel</a></p> --}}
                    </div>
                </div>
