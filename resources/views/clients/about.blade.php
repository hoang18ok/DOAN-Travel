    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-xl-3" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                <span class="subtitle mb-35">Giới thiệu chúng tôi</span>
            </div>
            <div class="col-xl-9">
                    ...
                    <div class="row">
                        <div class="col-lg-8 pe-lg-5 me-lg-5">
                            <div class="section-title mb-25">
                                <h2>Công ty du lịch chuyên nghiệp ở Việt Nam</h2>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            <p>Chúng tôi không chỉ tạo ra những chuyến đi, chúng tôi kiến tạo những ký ức đô thị khó phai.
                                Hãy cùng những hướng dẫn viên am tường của chúng tôi đắm mình vào nhịp sống của ba miền Việt Nam,
                                mỗi nơi một vẻ, một câu chuyện riêng,Mỗi chuyến đi là một hành trình được thiết kế tỉ mỉ,
                                đưa bạn qua những con phố náo nhiệt, 
                                những công trình kiến trúc vượt thời gian và cả những góc nhỏ bình yên ít người biết đến.
                            </p>
        ...
        <div class="row align-items-center">
            <div class="col-xl-4 col-md-6">
                <div class="about-feature-image" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <img src="{{ asset('clients/assets/images/about/1about-feature1.jpg') }}" alt="About">
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
                ...
                <div class="about-feature-boxes" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500"
                    ...
                    <div class="feature-item style-three bgc-secondary">
                        <div class="icon-title">
                            ...
                            <h5><a href="#">Chúng tôi là công ty du lịch đầy uy tín </a></h5>
                        </div>
                        <div class="content">
                            <p> Cam kết về sự xuất sắc và đổi mới đã đạt được</p>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-xl-7 col-lg-6" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                <div class="about-feature-image" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                    <img src="{{ asset('clients/assets/images/about/1about-page.jpg') }}" alt="About">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item hover-content" data-aos="fade-up" data-aos-duration="1500"
                    data-aos-offset="50">
                    <img src="{{ asset('clients/assets/images/team/1guide-dien.jpg') }}" alt="Guide">
                    <div class="content">
                        <h6>NGUYEN VAN HOANG </h6>
                        <span class="designation">Founder</span>
                        <div class="social-style-one inner-content">
                            <a href=""><i class="fab fa-twitter"></i></a>
                            <a href="https://www.facebook.com/hoang.nguyen.van.90894"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item hover-content" data-aos="fade-up" data-aos-duration="1500"
                    data-aos-offset="50">
                    <img src="{{ asset('clients/assets/images/team/11guide-dien.jpg') }}" alt="Guide">
                    <div class="content">
                        <h6>HOANG OTIS </h6>
