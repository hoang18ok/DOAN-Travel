        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="section-title text-white text-center counter-text-wrap mb-70" data-aos="fade-up"
                    ...
                    <h2>Khám phá 3 miền Việt Nam cùng chúng tôi </h2>
                    <p>Địa điểm du lịch phổ biến nhất mà bạn sẽ thích </p>{{-- <span class="count-text plus" data-speed="3000" data-stop="24080">0</span> --}}
            ...
            <div class="col-xl-7 col-lg-6" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                <div class="about-us-image">
                    ...
                    <div class="shape"><img src="{{ asset('clients/assets/images/about/shape7.png') }}"
                            alt="Shape"></div> --}}
                    <img src="{{ asset('clients/assets/images/about/1about.png') }}" alt="About">
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="section-title text-center counter-text-wrap mb-70" data-aos="fade-up"
                        data-aos-duration="1500" data-aos-offset="50">
                        <h2>Tìm hiểu các điểm đến được yêu thích</h2>
                        <p>Website <span class="count-text plus" data-speed="3000" data-stop="4321">0</span> trải
            ...
            <div class="col-xl-6">
                <div class="features-content-part mb-55" data-aos="fade-left" data-aos-duration="1500"
                    ...
                    <div class="section-title mb-60">
                        <h2>Trải nghiệm các địa danh và văn hóa các miền việt nam cùng chúng tôi </h2>
                    </div>
                    <div class="features-customer-box">
                        <div class="image">
                            <img src="{{ asset('clients/assets/images/features/1features-box.jpg') }}" alt="Features">
                        </div>
                        <div class="content">
                            ...
                            <div class="divider style-two counter-text-wrap my-25"><span><span class="count-text plus"
                                    ...
                                    Năm</span></div>
                            <p>Chúng tôi luôn cung cấp các trải nhiệm và cảnh đẹp tuyệt vời </p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-4 col-md-6" data-aos="zoom-in-down" data-aos-duration="1500" data-aos-offset="50">
                <div class="cta-item"
                    style="background-image: url( {{ asset('clients/assets/images/cta/1cta1.jpg') }});">
                    <span class="category">Khám Phá Cảnh Đẹp Núi Rừng Việt Nam </span>
                    <h2>Tìm hiểu những giá trị văn hóa các vùng miền Việt Nam.</h2>
            ...
            <div class="col-xl-4 col-md-6" data-aos="zoom-in-down" data-aos-delay="50" data-aos-duration="1500"
                data-aos-offset="50">
                <div class="cta-item"
                    style="background-image: url( {{ asset('clients/assets/images/cta/1cta2.jpg') }});">
                    <span class="category">Khám Phá các bãi biển và biển đảo Việt Nam</span>
            ...
            <div class="col-xl-4 col-md-6" data-aos="zoom-in-down" data-aos-delay="100" data-aos-duration="1500"
                data-aos-offset="50">
                <div class="cta-item"
                    style="background-image: url( {{ asset('clients/assets/images/cta/1cta3.jpg') }});">
                    <span class="category">Thác nước</span>
                    <h2>Thác nước Việt Nam</h2>
                    <a href="{{ route('tours') }}" class="theme-btn style-two bgc-secondary">
                        <span data-hover="Khám phá">Khám phá</span>
                        <i class="fal fa-arrow-right"></i>
                    </a>
