            ...
            <div class="col-lg-4">
                <div class="contact-info-content mb-30 rmb-55" data-aos="fade-up" data-aos-duration="1500"
                    ...
                    <div class="section-title mb-30">
                        <h2>Trải Nghiệm hướng dẫn viên du lịch chuyên nghiệp của chúng tôi</h2>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50"
                            ...
                            <div class="content">
                                ...
                                <div class="text"><i class="far fa-envelope"></i> <a
                                        href="">vanhoang18012003@gmail.com</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50"
                            ...
                            <div class="content">
                                <h5>Nghệ An </h5>
                                <div class="text"><i class="fal fa-map-marker-alt"></i> Kim Liên, Nam Đàn,Nghệ An </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50"
                            ...
                            <div class="content">
                                <h5>UTT </h5>
                                <div class="text"><i class="fal fa-map-marker-alt"></i> 54 P. Triều Khúc, Thanh Xuân Nam, Thanh Xuân, Hà Nội</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5">
                <div class="contact-images-part" data-aos="fade-right" data-aos-duration="1500"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <img src="{{ asset('clients/assets/images/contact/1contact1.jpg') }}" alt="Contact">
                        </div>
                        <div class="col-6">
                            <img src="{{ asset('clients/assets/images/contact/1contact2.jpg') }}" alt="Contact">
                        </div>
                        <div class="col-6">
                            <img src="{{ asset('clients/assets/images/contact/1contact3.jpg') }}" alt="Contact">
                        </div>
                    </div>
                    <div class="circle-logo">
                        <img src="{{ asset('clients/assets/images/contact/1icon.png') }}" alt="Logo">
...
<div class="contact-map">
    <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3725.1956758640486!2d105.79625707529983!3d20.984791980653508!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135acc6bdc7f95f%3A0x58ffc66343a45247!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBDw7RuZyBuZ2jhu4cgR2lhbyB0aMO0bmcgVuG6rW4gdOG6o2k!5e0!3m2!1svi!2s!4v1746888183029!5m2!1svi!2s"
