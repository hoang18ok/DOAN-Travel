...
<p style="font-size: 16px; font-family: Arial, sans-serif; color: #333;">Cảm ơn bạn đã đặt tour tại Travel. Vui lòng xem chi tiết hóa đơn trong file đính kèm.</p>
        ...
        <section class="content invoice">
            ...
            <div class="row invoice-info" style="margin-bottom: 20px;">
                ...
                <div class="col-sm-4 invoice-col" style="font-size: 14px;">
                    Đến
                    <address>
                        <strong>Công ty Travel</strong><br>
                        Kim Liên<br>
                        Nam Đàn, Nghệ An <br>
                        Phone: 1 (804) 123-9876<br>
                        Email: Vanhoang18012003@gmail.com
                    </address>
                </div>
                <br>
                <div class="col-sm-4 invoice-col" style="font-size: 14px;">
